...
rank gives $T_{\mathrm{sem}} = 1$ without any deterministic state label. Finite-length
equivalence bounds for weighted automata and HMMs are established territory, so we claim
Corollary~\ref{cor:stoch} as a statement inside this framework rather than as new to that
literature.
