...
We state Proposition~\ref{prop:finite} for the model actually formalised here: finite
hidden-state set, finite observation alphabet, deterministic state observation,
time-homogeneous transitions, exact finite-dimensional laws. The proof uses the
deterministic selectors directly and we do not extend it to stochastic emissions,
controlled processes, continuous state, or empirically estimated laws.
