...
measurement is narrower and we state it plainly: that informativeness is a genuine partial
order, with a single intervention less identifying than passive observation; that
