...
Experiment~30 are of exactly this kind. In the sample the kernel dimension stabilised at
$T \le 3$ throughout---$142$, $261$ and $59$ pairs at $T = 1, 2, 3$---though by
Proposition~\ref{prop:mono} a plateau bounds the kernel from above without proving
stabilisation for all $T$, which would need a finite-rank argument we do not have.
